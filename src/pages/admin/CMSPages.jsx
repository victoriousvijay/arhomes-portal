    ...
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
      ...
      {activeTab === 'owners' && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold text-white">The Three Co-Founders & Leadership</h2>
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#aa8c2c] text-[#013724] font-bold text-xs shadow-md cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {owners.map((owner, idx) => (
              <div 
                key={owner.id}
                className="p-5 rounded-2xl bg-[#091a13]/80 border border-white/10 shadow-xl flex flex-col justify-between space-y-4 hover:border-[#D4AF37]/40 transition-all"
              >
                <div className="space-y-4">
                  <div className="relative h-60 rounded-xl overflow-hidden bg-black/40 border border-white/10">
                    <img
                      src={formatGoogleDriveUrl(owner.image)}
                      alt={owner.name}
                      className="w-full h-full object-cover object-top"
                    />
                    <div className="absolute top-2 left-2 px-2 py-0.5 rounded-full bg-black/70 backdrop-blur-sm border border-white/20 text-[10px] text-[#D4AF37] font-bold">
                      Founder #{idx + 1}
                    </div>
                  </div>

                  <div>
                    <h3 className="text-base font-bold text-white">{owner.name}</h3>
                    <p className="text-xs text-[#D4AF37] font-medium mt-0.5">{owner.role}</p>
                    <p className="text-[11px] text-emerald-400 font-mono mt-0.5">{owner.credentials}</p>
                ...
                <div className="pt-3 border-t border-white/10 flex items-center justify-between">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/10 hover:bg-white/20 text-white text-xs font-semibold cursor-pointer"
                  >
      ...
      {activeTab === 'gallery' && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold text-white">Visual Portfolio & Architecture Gallery</h2>
              <p className="text-xs text-gray-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {gallery.map((item) => (
              <div 
                key={item.id}
                className="rounded-2xl bg-[#091a13]/80 border border-white/10 overflow-hidden shadow-xl flex flex-col group hover:border-[#D4AF37]/40 transition-all"
              >
                <div className="relative h-44 bg-black/40 overflow-hidden">
                  ...
                  />
                  <div className="absolute top-2 left-2 px-2 py-0.5 rounded-full bg-black/70 backdrop-blur-sm border border-white/20 text-[10px] text-[#D4AF37] font-bold uppercase">
                    {item.category}
                  </div>
                </div>
      ...
      {activeTab === 'buyHero' && (
        <div className="space-y-6">
          <div>
            <h2 className="text-lg font-bold text-white">Buy Page Hero Carousel Manager</h2>
            <p className="text-xs text-gray-400 mt-0.5">
              Toggle which properties are showcased in the top hero slider on the Buy page.
            </p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-[#091a13]/80 p-5 space-y-4">
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] text-[#D4AF37] font-semibold">{prop.price}</p>
                    </div>
                  </div>
      ...
      {/* MODAL: EDIT/ADD OWNER */}
      {isOwnerModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#081810] border border-white/20 rounded-2xl w-full max-w-lg p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95">
            ...
            <form onSubmit={saveOwnerSubmit} className="space-y-3.5 text-xs">
              <div>
                <label className="block text-gray-300 font-semibold mb-1">Founder Full Name *</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-gray-300 font-semibold mb-1">Executive Role *</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-gray-300 font-semibold mb-1">Area of Expertise</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="block text-gray-300 font-semibold mb-1">Degrees & Credentials</label>
                <input
                  type="text"
              ...
              <div className="p-3 rounded-xl bg-black/50 border border-white/10 space-y-2">
                <label className="text-gray-200 font-bold block">Photo (Local File or Google Drive URL) *</label>
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white font-semibold flex items-center gap-1.5 cursor-pointer"
                  >
                ...
                {ownerForm.image && (
                  <div className="flex items-center gap-2 pt-1">
                    <img 
                      ...
                      alt="Preview" 
                      className="w-10 h-10 object-cover rounded-full border border-[#D4AF37]" 
                    />
                    <span className="text-[10px] text-gray-400 truncate">Photo selected</span>
                  </div>
                )}
              </div>
      ...
      {isGalleryModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#081810] border border-white/20 rounded-2xl w-full max-w-lg p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95">
            ...
            <form onSubmit={saveGallerySubmit} className="space-y-3.5 text-xs">
              <div>
                <label className="block text-gray-300 font-semibold mb-1">Photo Title / Caption *</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-gray-300 font-semibold mb-1">Locality / Project</label>
                  <input
                    type="text"
