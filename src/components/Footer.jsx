...
export const Footer = ({ onOpenEnquiry }) => {
  ...
  const facebookVal = settings?.facebook || BRAND.facebook;
            ...
            <div className="pt-3 border-t border-[#205843]/60">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-full bg-[#002719] hover:bg-[#FF0000] text-[#D4AF37] hover:text-white border border-[#205843] hover:border-[#FF0000] flex items-center justify-center transition-all duration-200 shadow-sm hover:scale-110 cursor-pointer"
